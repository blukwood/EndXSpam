...
@app1.on_message(filters.command("purge", PREFIX))
@app2.on_message(filters.command("purge", PREFIX))
...
@app1.on_message(filters.command("del", PREFIX))
@app2.on_message(filters.command("del", PREFIX))
